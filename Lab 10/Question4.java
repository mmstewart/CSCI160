...
public class Question4 
{
    ...
    */
    public static void Question4()
    {
        try
        {
            PrintWriter pw = new PrintWriter("files/question4/MySecretsOfTheUniverse.txt");
            pw.println("Has 10 cats");
            pw.println("Drives a Hummer H3");
            pw.println("Takes tennis lessons at 3");
            pw.close();
        }
